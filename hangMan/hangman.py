...
def clicked(alphabet):
    ...
    if answer == 'INVERT':
        ...
        if btn01["text"] == "I" and btn02["text"] == "N" and btn03["text"] == "V" and btn04["text"] == "E" and btn05[
            "text"] == "R" and btn06["text"] == "T":
        ...
        if alphabet in answer:
            ...
            if chances < 0:
                messagebox.showinfo("Loose to guess", "Hanged!!!!!")
                window.destroy()
            if btn01["text"] == "E" and btn02["text"] == "S" and btn03["text"] == "C" and btn04["text"] == "A" and \
                    btn05["text"] == "P" and btn06["text"] == "E":
                messagebox.showinfo("congratulations", "Win the Game Great Buddy!!!!")
                window.destroy()
            print(chances)
        ...
        if alphabet in answer:
            ...
            if btn01["text"] == "A" and btn02["text"] == "B" and btn03["text"] == "R" and btn04["text"] == "O" and \
                    btn05["text"] == "A" and btn06["text"] == "D":
                messagebox.showinfo("congratulations", "Win the Game Great Buddy!!!!")
                window.destroy()
            print(chances)
    elif answer == 'ENOUGH':
        if alphabet in answer:
            ...
            if chances < 0:
                messagebox.showinfo("Loose to guess", "Hanged!!!!!")
                window.destroy()
            if btn01["text"] == "E" and btn02["text"] == "N" and btn03["text"] == "O" and btn04["text"] == "U" and \
                    btn05["text"] == "G" and btn06["text"] == "H":
                messagebox.showinfo("congratulations", "Win the Game Great Buddy!!!!")
                window.destroy()
            print(chances)
...
btn21 = Button(window, text="F", bg="skyBlue", fg="Black", width=3, height=1, font=('Helvetica', '20'),
               command=lambda: clicked("F"))
btn21.grid(column=1, row=2)
btn22 = Button(window, text="G", bg="skyBlue", fg="Black", width=3, height=1, font=('Helvetica', '20'),
               command=lambda: clicked("G"))
btn22.grid(column=8, row=2)
btn23 = Button(window, text="H", bg="skyBlue", fg="Black", width=3, height=1, font=('Helvetica', '20'),
               command=lambda: clicked("H"))
btn23.grid(column=1, row=3)
btn24 = Button(window, text="J", bg="skyBlue", fg="Black", width=3, height=1, font=('Helvetica', '20'),
               command=lambda: clicked("J"))
btn24.grid(column=2, row=3)
btn25 = Button(window, text="K", bg="skyBlue", fg="Black", width=3, height=1, font=('Helvetica', '20'),
               command=lambda: clicked("K"))
btn25.grid(column=7, row=3)
btn26 = Button(window, text="Q", bg="skyBlue", fg="Black", width=3, height=1, font=('Helvetica', '20'),
               command=lambda: clicked("Q"))
btn26.grid(column=8, row=3)
